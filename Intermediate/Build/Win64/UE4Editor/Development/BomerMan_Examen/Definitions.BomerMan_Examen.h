...
#define UE_PROJECT_NAME BomerMan_Examen
#define UE_TARGET_NAME BomerMan_ExamenEditor
#define UE_MODULE_NAME "BomerMan_Examen"
...
#define BOMERMAN_EXAMEN_API DLLEXPORT
